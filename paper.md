...
In the past graphical methods have been favoured, derived from the solutions of Thiem [@thiem] for the stationary case, and Theis [@theis:1935] if time-dependent drawdown has been recorded. Extensions for the leaky aquifer that is overlain by a semi-permeable layer, were presented by de Glee [@deglee:1930] for the steady state and Hantush (1955, 1956) for the time dependent case. Numerous further extensions have been developed for special cases [@renard:2005]. Nowadays the evaluation is mostly done on a computer. 
